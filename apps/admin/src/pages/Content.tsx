      ...
      <div className="toolbar" style={{ alignItems: 'flex-start' }}>
        <div>
          ...
          {!isExam && can('content.create') && (
            <span title="Remembered default — pre-fills Questions per set in Bulk add sets" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: '#f7f9fd', border: '1px solid var(--line)', borderRadius: 12, padding: '5px 10px', marginTop: 12 }}>
              ...
              <span style={{ display: 'inline-flex', alignItems: 'center', border: '1.5px solid var(--line)', borderRadius: 9, overflow: 'hidden', background: '#fff' }}>
                ...
                <input type="text" inputMode="numeric" pattern="[0-9]*" value={defPerSet} onChange={e => setDefault(Number(e.target.value.replace(/\D/g, '')))}
                  style={{ width: 56, textAlign: 'center', border: 0, borderLeft: '1px solid var(--line)', borderRight: '1px solid var(--line)', borderRadius: 0, fontWeight: 700, fontSize: 14 }} />

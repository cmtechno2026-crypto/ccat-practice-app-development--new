...
export const TIER_CATALOG: Record<EntitlementTier, TierInfo> = {
  ...
  t50: { tier: 't50', label: '$49', name: 'Standard', price: '$49', priceLabel: '$49 CAD', accessTerm: '1-year access',
  ...
  t250: { tier: 't250', label: '$99', name: 'Plus', price: '$99', priceLabel: '$99 CAD', accessTerm: '1-year access',
  ...
  t500: { tier: 't500', label: '$199', name: 'Premium', price: '$199', priceLabel: '$199 CAD', accessTerm: '1-year access', badge: 'BEST VALUE',

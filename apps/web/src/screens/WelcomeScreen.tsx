...
const STEPS = [
  ...
  ['2', "Pick your child's grade", 'Content is targeted to the right grade, Grades 2 to 5.'],
      ...
      <section className="lp-hero">
        <div className="lp-hero-in">
          <div>
            ...
            <div className="lp-trust">✔ Trusted by 500+ parents · ✔ Grades 2–5 · ✔ PIPEDA-compliant</div>
          </div>
